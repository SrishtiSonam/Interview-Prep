...
async def generate_resume(resume_input: ResumeInput):
    ...
    try:
        ...
        input_data = {
            ...
            "email": str(resume_input.email),
            "linkedin": resume_input.linkedin,
            "github": resume_input.github,
            "education": resume_input.education,
            "experience": resume_input.experience,
            "projects": resume_input.projects
        }

        # Run ATS workflow and generate resume data
        result = run_resume_ats_workflow(input_data)
